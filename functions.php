...
function s4f_script_enqueue()
{
    ...
    wp_enqueue_style('google_fonts', 'https://fonts.googleapis.com/css2?family=Crimson+Pro:ital,wght@0,300;0,400;0,700;1,300;1,400;1,700&family=Roboto+Mono:ital,wght@0,400;0,700;1,400;1,700&display=swap', false, NULL, 'all' );
