...
add_action( 'tgmpa_register', 'morse_wp_theme_register_required_plugins' );

function morse_wp_theme_register_required_plugins() {
    error_log("running");
    /*
    ...
    $plugins = array(
        array(
            'name'      => 'Stem4Free Site Specific Plugin',
            'slug'      => 's4f-plugin',
            'required'  => true,
            'source' => "https://github.com/wwsalmon/s4f-plugin/archive/master.zip"
        )
    );
