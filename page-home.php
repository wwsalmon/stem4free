...
<div class="container-1200 mt-6 mb-6 pt-4">
    ...
    <p class="width-700 text-center font-mono font-16-lt-600 link-underline"><span class="opacity-20">in <span id="s4f-top-branch"><?php echo get_theme_mod("s4f-stat-state-1-fallback", "Texas (6,800+)") ?></span>, <span id="s4f-second-branch"><?php echo get_theme_mod("s4f-stat-state-2-fallback", "California (800+)") ?></span>, and <a href="./branches"><?php echo get_theme_mod("s4f-num-other-locations", "9") ?> other locations</a>, </span><span class="opacity-60">with <?php echo get_theme_mod("s4f-stat-last-week-fallback", "1,000+") ?> meals rescued in the last week.</span></p>
    <script>
